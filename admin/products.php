                ...
                <tbody class="table-group-divider">
                    <?php foreach ($products as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?= $row['product_id'] ?>" class="btn btn-primary me-3"><i class="bi bi-pencil"></i> Modifier</a>
                                <a href="delete.php?id=<?= $row['product_id'] ?>" class="btn btn-danger"><i class="bi bi-trash3"></i> Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
